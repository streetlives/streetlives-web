...
export default {
  ...
  googleMaps: process.env.REACT_APP_GMAPS_URL || 'https://maps.googleapis.com/maps/api/js?key=AIzaSyABZdHZ1R0cssL9BL9Kx3LpbmDfDJ6oPEc&v=3.exp&libraries=geometry,drawing,places',
