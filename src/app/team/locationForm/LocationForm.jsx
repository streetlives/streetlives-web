...
class LocationForm extends Component {
  constructor(props) {
    ...
    this.routeComponents = routes.map(({
      ...
      <Route
        key={urlFragment}
        path={`/team/location/:locationId/${urlFragment}/:thanks?`}
  ...
  onBack() {
    ...
    this.props.history.push(`/team/location/${locationId}/${urlFragment}`);
    this.onInputBlur();
  }
  ...
  onBackSection() {
    const { locationId } = this.props.match.params;
    this.props.history.push(`/team/location/${locationId}`);
  }
    ...
    return (
      <div className="text-left">
        <div style={overlayStyles(thanks)}>
          ...
          <NavBar backButtonTarget={`/team/location/${locationId}`} title={currentRoute.label} />
